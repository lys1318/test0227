...
public class YanoljaGuesthouse {
	String tc_id;
	Long time;
	...
	@Parameters("browser")
	@Test
	public void test_GHHome_view (String browser) throws InterruptedException {
		...
		try {
			...
			Home.quickCategoryGuestHouse();
			
			Thread.sleep(5000);
			
			assertEquals(Dilog.assertLogByDesc("GHHome", "web", "게스트 하우스 서브홈 화면 진입", "view", time),true);
