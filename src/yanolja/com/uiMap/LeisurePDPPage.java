...
public class LeisurePDPPage {
	...
	// CountUp
	public static WebElement countUp() {
		element = Browser.driver().findElement(By.cssSelector("div[class^='OptionItem'] > div[class^='Counter_container'] > button[class*='Counter_buttonRight']"));
